...
if __name__ == "__main__":
    dirs = [
        "ml/data/scraped_data/tanishq/tamil_nadu_images",
        "ml/data/scraped_data/tanishq/bengal_images",
        "ml/data/scraped_data/basanti"
    ]
    label_images(dirs, "ml/data/scraped_data/labeled", num_clusters=6)
