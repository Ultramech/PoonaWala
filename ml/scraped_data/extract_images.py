...
if __name__ == "__main__":
    extract_images_from_pdf("ml/scraped_data/tanishq/tamil_nadu.pdf", "ml/scraped_data/tanishq/tamil_nadu_images")
    extract_images_from_pdf("ml/scraped_data/tanishq/bengal.pdf", "ml/scraped_data/tanishq/bengal_images")
